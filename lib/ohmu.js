...
;(function(){
    ...
    var ohmu = {};
    var bus = this.catbus;
    var dataTree = bus.demandTree('OHMU'); // todo host should be defined within a tree
    var suffixOnRequests = '';

    var infoData = dataTree.demandData('INFO'); // topics are urls, data is full file dependency info
    var contextHash = {};
